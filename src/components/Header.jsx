      ...
      <div className="container space-y-1.5">
        ...
        <div className="main-menu flex justify-between items-center ">
          <div className="header__left flex lg:inline-block gap-2">
            <SearchIcon width={26} height={26} className='hidden lg:inline-block' />
            <CartBag width={26} height={26} className='lg:hidden'/>
          </div>
          ...
          <div className="header__right">
            <CartBag width={26} height={26} className='hidden lg:inline-block'/>
